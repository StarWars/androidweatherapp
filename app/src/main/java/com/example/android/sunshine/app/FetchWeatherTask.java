...
/**
 * Created by michalstawarz on 28/07/15.
 */
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    private final String LOG_TAG = FetchWeatherTask.class.getSimpleName();
    FetchWeatherListener listener;

    public FetchWeatherTask(FetchWeatherListener listener) {
    ...
    protected void onPostExecute(String[] result) {
        if (result != null) {
            listener.onNewWeatherData(result);
        }
    }
    ...
    protected String[] doInBackground(String... strings) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(FORAMT_PARAM, responseFormat)
    ...
    public interface FetchWeatherListener {
        void onNewWeatherData(String[] weatherArr);
    }
